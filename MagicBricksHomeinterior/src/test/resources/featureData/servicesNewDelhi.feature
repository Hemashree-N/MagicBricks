Feature: servicesNewDelhi

Scenario: Validate user is able to click on  New delhi and navigate to the Interior Designers in new delhi
...
And user should be able to click on New delhi
And user should be navigated to the Interior Designers in new delhi
And user should be able to scroll down 
And user should be able to click on Kitchen & Wardrobes
