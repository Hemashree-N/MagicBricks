...
import elementRepository.SignUpPage;
...
public class HiSignUp {
	...
	public void enter_the_valid_credentials() throws InterruptedException {
		...
		signUpPage.getGetNameTextField().sendKeys("HemaS");
		signUpPage.getGetEmailTextField().sendKeys("hema@gamil.com");
		signUpPage.getGetPasswordTextField().sendKeys("Ram@seet123");
		signUpPage.getGetMobileTextField().sendKeys("8466880899");
